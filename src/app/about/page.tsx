...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about Fav Fare\'s mission, our expert team, and our state-of-the-art clinic.',
};
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
            ...
            <div className="md:col-span-3">
              <h2 className="text-3xl md:text-4xl font-bold font-headline mb-2">Meet Dr. Favfare</h2>
              <p className="text-primary font-semibold mb-4">Lead Dentist & Founder</p>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Dr. Favfare is a graduate of the University of UniversityName School of Dental Medicine and has over 15 years of experience in cosmetic and restorative dentistry. He/She is passionate about creating beautiful, healthy smiles and is dedicated to lifelong learning in his/her field.
                </p>
                <p>
                ...
                <Button asChild variant="ghost" className="text-primary hover:text-primary">
                  <Link href="#" aria-label="Dr. Favfare's LinkedIn Profile">
